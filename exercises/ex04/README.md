...
12. Select the folder `TECHED2025-DA264` and enter the following details.<br><ul><li>Business Name: **Sales Model - Entity-Relationship Model**</li><li>Technical Name: **Sales_ER_Model**
